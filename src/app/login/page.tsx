...
export default function Login() {
  ...
  const handleSubmit= async (e:any) =>{
    ...
    const login= await fetch(`${process.env.apiUrl}/auth/loginadmin`,{
      method:'POST',
      headers: {
    ...
    if(login.ok){
      ...
      await setCookie('tokenadmin', data.data.token);
      await setCookie('idadmin', data.data.payload.id);
